...
- 项目目录：`C:\Users\<username>\.openclaw\knowledge\notebooklm\projects`
- 输出目录：`C:\Users\<username>\.openclaw\knowledge\notebooklm\output`
- 状态索引：`C:\Users\<username>\.openclaw\knowledge\notebooklm\registry.json`
...
```powershell
python C:\Users\<username>\.openclaw\skills\notebooklm-output\scripts\output.py generate --project "<项目名>" --type "<输出类型>"
```
