...
- 输出目录：`{.openclaw根}/knowledge/notebooklm/output`
...
```powershell
python "{本skill目录}/scripts/output.py" inspect --project "<项目名>"
```

执行输出：

```powershell
python "{本skill目录}/scripts/output.py" generate --project "<项目名>" --type "<输出类型>"
```
