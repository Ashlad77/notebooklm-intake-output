...
```powershell
python C:\Users\<你的用户名>\.openclaw\skills\notebooklm-output\scripts\output.py inspect --project "<项目名>"
```

### 生成输出

```powershell
python ...\output.py generate --project "<项目名>" --type "<输出类型>"
```

例如：
```powershell
python ...\output.py generate --project "2026-04-04-论文写作项目" --type "report"
```
...
mind-map 的 HTML 内联了 D3.js 和 Markmap 库，生成的文件**完全自包含**，无需网络即可打开。
...
例如：`2026-04-04-测试项目-可交互思维导图-2026-04-07_14-30.md`

---

## 在新机器上复刻

每个 skill 都有独立的复刻指南，包含完整的文件内容、路径替换说明和 Smoke test 流程：
