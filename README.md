...
- [notebooklm-py](https://github.com/teng-lin/notebooklm-py) — 提供 NotebookLM CLI 与 Python 调用能力

---

## 当前状态

MVP 已完成，真实云端上传链路已跑通并通过 smoke test 和真实业务测试。详见 [`USAGE-AND-STATUS.md`](notebooklm-intake/USAGE-AND-STATUS.md)。
